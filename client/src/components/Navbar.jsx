...
border-gray-300/20 overflow-hidden transition-[width] duration-300 ${isOpen ? 'max-md:w-full': 'max-md:w-0'} `}>
                ...
                {/*//* Scroll to is written cause when loading to new page so the page loads from starting not from any mid if want to load where the user left then simply remove the scroll to option */}
